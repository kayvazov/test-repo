import { P as Pagination } from './Pagination-CpQqROxt.js';
...
const Template = (props)=>({
        ...
        template: "<Pagination :total='total' :size='size' :page='page' :setPage='setPage'/>"
    });
...
Default.args = {
    ...
    size: 20,
    page: 3,
    setPage: (page)=>console.info(`Set page: ${page}`)
};
...
export { Default, __namedExportsOrder, Pagination_stories as default };
