import { H as Hint } from './Hint-DY9b0z9j.js';
...
const Template = (props)=>({
    ...
    <section>
        ...
        <Hint class="ml-1">
          Authoritatively fashion corporate vortals before multifunctional synergy. Intrinsicly maintain an expanded array of.
        </Hint>
    </section>
  `
    });
...
export { Default, __namedExportsOrder, Hint_stories as default };
